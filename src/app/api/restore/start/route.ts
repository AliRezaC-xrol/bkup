...
import { startRestore, type RestoreRequest, type PanelId } from "@/lib/restore-service";
...
export async function POST(req: NextRequest) {
  ...
  const panel = String(body.panel ?? "") as PanelId;
  ...
  if (!["3x-ui", "hmpanel", "pasarguard", "rebecca"].includes(panel)) {
